            ...
            <div class="login-wrap">
                ...
                <label class="checkbox">
                    <span class="pull-right">
                        <a data-toggle="modal" href="login.html#myModal">Lupa Kata Sandi?</a>   
                    </span>
                </label>
                <button id="btn" class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> Masuk</button>
                <br/>
                <div class="registration">
                    Tidak mempunyai akun?<br/>
                    <a class="" href="<?php echo base_url();?>index.php/signup">
                        Buat sebuah Akun
                    </a>
                </div>
